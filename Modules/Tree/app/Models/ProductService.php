...
class ProductService extends Model implements HasMedia
{
     ...
     */
    protected $fillable = ["id", "id_priority", "name", 'status', 'description', "number_tree", "acreage", "free_visit", "amount_products_received", 'price', 'number_deliveries',"number_receive_product", "life_time", "unit","transfer_value","price_origin"];
