...
class ApiShipperController extends Controller
{
    ...
    public function getOrderStatus(Request $request)
    {
        ...
        $statusGroup = OrderTransport::whereHas('order', function ($q) use ($user) {
            ...
            ->groupBy('status')
            ->get();
        $array_status =  [OrderTransportStatus::not_shipping->value, OrderTransportStatus::not_delivered->value, OrderTransportStatus::delivered->value, OrderTransportStatus::wait_refund->value, OrderTransportStatus::wait_decline->value, OrderTransportStatus::refund->value, OrderTransportStatus::decline->value];
