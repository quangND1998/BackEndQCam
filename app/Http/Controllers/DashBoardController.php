...
class DashBoardController extends Controller{
    ...
    public function leaderSale(Request $request){
        ...
        if($user->hasRole('leader-sale')){
            ...
            return $this->packageOrderService->formatDataAnalyticTeam($request->only('date','from', 'to', 'day'),$userIds);
        }
        // return $order_packages;
        return Inertia::render('HomeView', compact( "top_ten_sale_data", 'week_data_user', 'month_data_user', 'year_data_user','team_sale_data','data_contract','ranking_team', 'ranking_all_server','order_packages','sumGrandTotalOrder','sumPricePercentOrder','analysticData'));
