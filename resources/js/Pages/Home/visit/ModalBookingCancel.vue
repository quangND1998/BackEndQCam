<template>
    <div class="modal fade rounded" id="ModelBookinCancel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
...
onMounted(() => {
    emitter.on('OpenModelBookinCancel', (visit) => {
        // console.log(order)

        form.id = visit.id
        form.id = visit.code
        $("#ModelBookinCancel").modal("show");
    })
});
const changeState = () => {
