        ...
        <SectionMain class="p-3 mt-8">
            ...
            <CardBoxModal v-model="isModalActive" buttonLabel="Save" has-cancel @confirm="save"
                    ...
                    <Multiselect v-model="form.permission" mode="tags" :appendNewTag="false" :createTag="false"
                        ...
                        class="form-control h-52 overflow-auto " :classes="{
                            tagsSearch: 'absolute inset-0 border-0 outline-none focus:ring-0 appearance-none p-0 text-base font-sans box-border w-full',
                            container: 'relative mx-auto w-full flex items-center py-3 justify-end box-border cursor-pointer border border-gray-300 rounded bg-white text-2xl leading-snug outline-none my-3',
                            tags: 'flex-grow flex-shrink flex flex-wrap items-center mt-1 my-2 pl-2 h-full  rtl:pl-0 rtl:pr-2',
                ...
                <table class="w-full text-xs text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        <tr v-for="(role, index) in roles.data" :key="index"
                            ...
                            <td class="py-2 px-3 text-right flex">
                                <button @click="edit(role)" type="button" data-toggle="modal" data-target="#exampleModal"
                                    class="inline-block px-3 py-2 bg-gray-200 text-gray-700 font-black text-xs leading-tight uppercase rounded shadow-md hover:bg-gray-300 hover:shadow-lg focus:bg-gray-300 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-gray-400 active:shadow-lg transition duration-150 ease-in-out mx-2">Edit</button>
                                <button type="button" @click="Delete(role.id)"
                                    class="inline-block px-3 py-2 bg-red-500 text-white font-black text-xs leading-tight uppercase rounded shadow-md hover:bg-red-600 hover:text-white hover:shadow-lg focus:bg-gray-900 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-gray-900 active:shadow-lg transition duration-150 ease-in-out">Delete</button>
                            </td>
                        </tr>
                    </tbody>
                </table>
