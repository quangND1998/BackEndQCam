...
const product_retails = toRef(props.products)
const form = useForm({
    id: null,
    name: null,
    state: null,
...
const searchProduct = () => {
    ...
    axios.get(`/admin/vouchers/${props.voucher.id}/products`, { params }).then(response => {
        product_retails.value = response.data
                ...
                <div class="relative mt-5 ">
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            ...
                            <tr v-for="(product, index) in product_retails.data" :key="index"
                    ...
                    <div v-if="product_retails.links.length > 3" class="mt-8 ml-4">
                        <div class="flex flex-wrap -mb-1">

                            <div v-for="(link, k) in product_retails.links" :key="k">
