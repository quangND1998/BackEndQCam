                        ...
                        <div class="min-[320px]:block sm:flex lg:flex my-3">
                            ...
                            <div class="min-[320px]:w-full lg:w-9/12 flex flex-wrap">
                                <div class="flex ">
                                    ...
                                    class="block p-2 ml-3 text-xs border border-gray-300 rounded-lg bg-blue-500 text-white focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">Search</button>
                                </div>
