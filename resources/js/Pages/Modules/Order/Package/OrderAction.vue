<template>
    <div class="flex justify-between">
        ...
        <div class="flex">
            ...
            <button  v-if="hasAnyPermission(['create-contract-complete']) && status == 'pending' && (order.payment_check == true && (order.price_percent >= order.grand_total))" @click="orderChangePacking(order)"
