                       ...
                       <InvoiceInformation :order="order" />
                        <div class="mt-5">
                            ...
                            <p class="text-[#686868] text-base my-2">Địa chỉ:
                                <strong class="ml-3">{{ order.address}}, {{ order.district }}, {{ order.wards }} ,{{ order.city }}  </strong></p>
                        </div>
                        <div class="mt-5">
                            ...
                            <div class="flex w-full justify-end mt-5">
                                ...
                                <div class="min-[320px]:w-full md:w-1/2">
                                    <div class="flex justify-between my-2">
                                        ...
                                        <p class="text-sm text-[#686868] font-bold"> {{ formatPrice(order?.product_service?.price) }} vnđ</p>
                                    </div>
                                    <div class="flex justify-between my-2">
                                        <p class="text-sm text-[#686868] font-bold">VAT({{order?.vat}}%)</p>
                                        <p class="text-sm text-[#686868] font-bold">{{ formatPrice(((order?.product_service?.price)*(order?.vat) )/100) }} vnđ</p>
                                    </div>
                                    <div class="flex justify-between my-2">
                                    ...
                                    <div class="flex justify-between my-2">
                                        ...
                                        <p class="text-sm text-[#686868] font-bold">{{ formatPrice(((order?.product_service?.price)*(order?.discount) )/100) }} vnđ</p>
                                    </div>
                                    <div class="flex justify-between my-2">
                                        <p class="text-sm text-[#686868] font-bold">Tổng cộng</p>
                                        <p class="text-sm text-[#686868] font-bold">{{ formatPrice(order?.grand_total ) }} vnđ</p>
                                    </div>
                                    <div class="flex justify-between my-2">
                                        <p class="text-sm text-[#686868] font-bold">Đã thanh toán</p>
                                        <p class="text-sm text-[#686868] font-bold">{{ formatPrice(order?.price_percent ) }} vnđ</p>
                                    </div>
                                    <div class="flex justify-between my-2">
                                        <p class="text-sm text-[#686868] font-bold">Còn lại</p>
                                        <p class="text-sm text-[#686868] font-bold">{{formatPrice(order?.grand_total -  order?.price_percent )}} vnđ</p>
                                    </div>
                                </div>
                            </div>
