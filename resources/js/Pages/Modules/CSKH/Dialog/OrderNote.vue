<template>
    <div class="modal fade" id="OrderNote" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-xl rounded-2xl mx-auto mt-10 shadow-lg max-h-modal w-8/12  md:w-9/12 lg:w-8/12 xl:w-5/12 z-50 overflow-auto"
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <div class="flex">
                        <div class="ml-2">
                            <h3 class="text-black font-base my-1 text-base">Đơn hàng #{{ order?.order_number }}</h3>
                ...
                <div class="modal-body  mx-1 mb-6">
                        ...
                        <div class="w-full flex  items-center mx-auto mt-3 ">
                            ...
                            <p class="text-[#000000] text-base">Ghi chú: Khách hàng nhận hàng trước 9h {{ order?.reason }}
                            </p>
                        </div>
                        <div class="w-full flex items-center mx-auto ">
                            <img src="/assets/icon/book.png" alt="" class="w-12 h-12 p-2">
                            <p class="text-[#000000] text-base ">Đ/c nhận hàng: {{ order?.customer.address
                                + ' ,' + order?.customer.wards + ' ,' + order?.customer.district + ' ,'
                                + order?.customer.city }}
                            </p>
                        </div>
                        <div class="w-full flex items-center mx-auto justify-between ">
                            ...
                            <div class="flex items-center">
                                ...
                                <p class="text-[#000000] text-base">SĐT phụ: {{ hasAnyPermission(['super-admin']) ?
                                    ...
                                    hidePhoneNumber(order?.customer?.phone_number) }}</p>
                            </div>
                        ...
                        <div class="w-full mx-auto border min-h-30 px-3 py-4">
                            <p v-for="(history, index) in order?.shipping_history" :key="index">
