            ...
            <div class="modal-content relative w-auto my-6 mx-auto max-w-3xl">
                <div
                    ...
                    <div class="flex items-start justify-between p-2  border-blueGray-200 rounded-t">
                        <div class="ml-2">
                            <h3 class="text-black font-base my-1 text-base">Đơn hàng #{{ data?.order_number }}</h3>
                        </div>
                    ...
                    <div class="modal-body  mx-1 mb-6">
                        ...
                        <div class="w-full flex items-center mx-auto ">
                            ...
                            <p class="text-[#000000] text-base ">Đ/c nhận hàng: {{ data?.customer.address
                                + ' ,' + data?.customer.wards + ' ,' + data?.customer.district + ' ,'
                                + data?.customer.city }}
                            </p>
                        </div>
                        <div class="w-full flex items-center mx-auto justify-between ">
                            ...
                            <div class="flex items-center">
                                ...
                                <p class="text-[#000000] text-base">SĐT phụ: {{ hasAnyPermission(['super-admin']) ?
                                    ...
                                    hidePhoneNumber(data?.customer?.phone_number) }}</p>
                            </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" v-if="data.state_document == 'not_approved'" @click="confirmStateDocument"
