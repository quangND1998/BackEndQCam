        ...
        <SectionMain class="p-3 mt-10">
            ...
            <div class="mt-3">
                <div class="w-full mt-2 h-[60vh] ">
                    <div class="bg-[#5C5C5C] text-white  grid grid-cols-[repeat(10,_minmax(0,_1fr))] divide-x">
                        ...
                        <div class="text-center py-2 border">Thời gian</div>
                        <div class="text-center py-2 border">NVCS</div>
                        <div class="text-center py-2 border">TT</div>
                        <div class="text-center py-2 border">Thứ/tuần/tháng</div>
                        <div class="text-center py-2 border">Loại</div>
                        <div class="text-center py-2 border">Ghi chú</div>
                        <div class="text-center py-2 border"></div>
                    </div>
                ...
                <pagination :links="history_calls.links" />
            </div>
