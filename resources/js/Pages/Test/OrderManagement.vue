...
<template>
    ...
    <!-- <OrderHome /> -->
        <div class="flex ">
            <div class="px-3 py-2  border border-gray-300 rounded-lg text-gray-500 text-sm mx-1">
                <a >Đơn chờ</a>
                <span>(50)</span>
            </div>
            <div class="px-3 py-2 border border-gray-300 rounded-lg text-gray-500 text-sm mx-1">
            ...
            <form v-on:submit.prevent>
              <div class="relative">
                <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                  <svg aria-hidden="true" class="w-5 h-5 text-sm text-gray-500 text-gray-400" fill="none"
                    stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                      d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                  </svg>
                </div>
                <input type="search" id="default-search" name="search" data-toggle="hideseek" laceholder="Search Menus"
    ...
    <div class="p-2 rounded-lg col-md-12">
      <div class="panel panel-default">
        <div class="panel-body relative overflow-x-auto shadow-md sm:rounded-lg">
          <div>
            <div
              class="grid grid-cols-5 gap-4 text-xs  uppercase bg-gray-600  px-3 py-4 text-gray-400">
              <div>
                <p>Mã đơn hàng</p>
              </div>
              <div>
              ...
              <div class="grid grid-cols-1 gap-4 bg-gray-300 p-3 border rounded-lg accordian-body collapse " id="demo1" >
                ...
                <table class="table table-striped w-full text-sm text-left text-gray-500 text-gray-400 rounded-lg">
                  ...
                  <tbody>
                    ...
                    <tr class="a bg-white bg-gray-800 border-gray-700 hover:bg-gray-50 hover:bg-gray-600">
                      <td class="px-6 flex py-4 font-medium text-gray-900 whitespace-nowrap ">
                        Chiết khấu
                      </td>
                      <td class="px-6 py-4"></td>
                      ...
                      <td class="px-6 py-4"></td>
                      <td class="px-6 py-4">
                        <input type="text" class="w-3/4 rounded-lg border border-gray-300" placeholder="0%" />
                      </td>
                    </tr>
                    <tr class=" bg-white bg-gray-800 border-gray-700 hover:bg-gray-50 hover:bg-gray-600">
                      <td class="px-6 flex py-4 font-medium text-gray-900 whitespace-nowrap ">
                      ...
                      <td class="px-6 py-4"></td>
                      <td class="px-6 py-4">
                        <input type="text" class="w-3/4 rounded-lg border border-gray-300" placeholder="30,000 đ" />
                      </td>
                    </tr>
                    <tr class=" bg-white bg-gray-800 border-gray-700 hover:bg-gray-50 hover:bg-gray-600">
                      <td class="px-6 flex py-4 font-medium text-gray-900 whitespace-nowrap ">
        ...
        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5 5 1 1 5"/>
              ...
              <div class="grid grid-cols-1 gap-4 bg-gray-300 p-3 border rounded-lg hidden " id="accordion-open-body-2"  aria-labelledby="accordion-open-heading-2">
                <div class="my-3 rounded-lg border">
                  <div class="title_information p-2">
                    <h3>Thông tin khách hàng</h3>
                  </div>
